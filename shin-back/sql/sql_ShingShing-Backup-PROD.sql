...
# Tiempo de Generaci�n: 2020-05-07 21:45:52 +0000
# ************************************************************
...
VALUES
	...
	(2,'Neto','',0),
	(3,'Walmart','http://res.cloudinary.com/shingshing/image/upload/v1588549684/shingshing/tiendas/Walmart.png',1),
...
VALUES
	...
	(3,'Agua Bonafont',0,NULL,NULL,'1.5 lt','Agua natural',0,NULL,NULL,1,1,'#FF6600',1,1,NULL,'',1),
	(4,'DEMO',0,NULL,NULL,'1.5 lt','Agua natural',0,NULL,NULL,5,1,'#FF6600',1,1,NULL,'',1),
	(5,'Aceite Quaker State',0,NULL,NULL,'960 ml','Aceite para motor, dale vida tu motor',0,NULL,NULL,10,1,'#FF6600',42,3,NULL,'',1),
	...
	(9,'Agua Natural Bonafont',0,NULL,NULL,'1.2 lt','Agua Bonafont con sabor natural',0,NULL,NULL,10,1,'#FF6600',1,12,NULL,'',1),
	(10,'Desodorante en aerosol AXE',0,NULL,NULL,'125 ml','Desodorante en aerosol de 125 ml. con fragancia fresca que dura 24 horas',0,NULL,NULL,7,1,'#FF6600',9,17,NULL,'',1),
	(11,'Aceite 1-2-3 ',0,NULL,NULL,'1 lt','Aceite vegetal comestible, que no contiene colesterol',0,NULL,NULL,7,1,'#FF6600',10,1,NULL,'',1),
	(12,'Colgate triple acción',0,NULL,NULL,'150 ml','Pasta de dientes xtra frescura, que contiene anticaries con fluor',0,NULL,NULL,2,1,'#FF6600',24,17,NULL,'',1),
	...
	(15,'Yougurt Natural Yoplait',0,NULL,NULL,'125 ml','Yogurt para beber Yoplait de sabor natural',0,NULL,NULL,2,1,'#FF6600',10,12,NULL,'',1),
	...
	(18,'Area para Gato',0,NULL,NULL,'2 Kg','Arena para gato',0,NULL,NULL,2,1,'#FF6600',13,10,NULL,'',1),
	...
	(21,'Jugo Del Valle',0,NULL,NULL,'500 ml','Jugo Del Valle sabor mango',0,NULL,NULL,1,1,'#FF6600',12,12,NULL,'',1),
	...
	(30,'Rancheritos',0,NULL,NULL,'50 gr','Rancheritos',0,NULL,NULL,1,1,'#FF6600',15,1,NULL,'http://res.cloudinary.com/shingshing/image/upload/v1581467902/shingshing/productos/Rancheritos.jpg',1),
	...
	(78,'*Cheetos Torciditos',0,NULL,NULL,'100 g','Botana de cereal de maíz con sabores queso y chile, reducida en grasa saturada.',0,NULL,NULL,2,3,'#FF7D06',46,1,NULL,'',1),
	(79,'*Choco Milk',0,NULL,NULL,'400 g',' Choco Milk®, que es un alimento en polvo fortificado para preparar una bebida a sabor chocolate. La fórmula Nutri Pantera tiene 23 Vitaminas y Minerales tales como Calcio, Hierro, Ácido Fólico y Vitaminas del complejo B que apoyan el desarrollo cada día',0,NULL,NULL,5,2,'#6591FF',47,1,NULL,'',1),
	(80,'*Heineken Six 00',0,NULL,NULL,'1 pza','¿En junta de trabajo? ¿Después del gym? ¿Antes manejar? ¡Tómate una Heineken 0.0. En serio, ahora puedes. conocer la primer cerveza premium sin alcohol en el mercado mexicano con Heineken 0.0. ',0,NULL,NULL,5,2,'#2B8A41',48,12,NULL,'',1),
	(81,'*Yakult ',0,NULL,NULL,'1 pza',' Yakult es un producto lácteo que está enriquecido con el lactobacilo Casei Shirota que protege el estómago en contra de enfermedades para fortalecer el sistema inmune de manera natural ya que es una bebida buena para la salud. Consciente a tu familia con este paquete de 5 Yakult, y mantenlos sanos.',0,NULL,NULL,2,2,'#C20F0F',28,14,NULL,'',1),
	(82,'*Boing Fresa',0,NULL,NULL,'250 ml','¡Ofrece a tus pequeños un delicioso Boing, solo para saciar su antojo!\r\nHecho a base de pulpa de fresa con un tamaño práctico para llevarlo a cualquier lugar, aporta sólo 84 kcal. Ofrécelo frío de preferencia.',0,NULL,NULL,2,2,'#F90427',49,1,NULL,'',1),
	(83,'Yoplait',0,NULL,NULL,'1kg','El desayuno es la comida más importante del día, así que empieza con el pie derecho con el yogurt natural Yoplait de 1 Kg.  Alcanza para 10 porciones aproximadamente, te aporta nutrientes favorables a tu cuerpo, como calcio y proteínas, ademas y no contiene conservadores ',0,NULL,NULL,3,2,'#000000',51,14,NULL,'',1),
	(84,'*NESQUICK LECHE ',0,NULL,NULL,'330 ml','Leche parcialmente descremada ultrapasteurizada adicionada de vitaminas, ( A y D ) reducida en azucar y grasa. Lista para beber sabor chocolate ',0,NULL,NULL,4,2,'',25,14,NULL,'',1),
	(85,'*Natural Good Shapes ',0,NULL,NULL,'500 ml ','Hidrata tu cuerpo y pon a volar tu mente con los sabores más exóticos. ¡Dale a tu cuerpo un delicioso respiro! Mejora tu digestión, estabiliza tus niveles de alcalinidad y reduce el colesterol.',0,NULL,NULL,3,1,'#0C61A2',52,14,NULL,'',1),
	(86,'*Choco Roles',0,NULL,NULL,'100 g','Los chocoroles Marinela son unos deliciosos pastelitos enrollados con relleno cremoso sabor piña y cobertura sabor chocolate, adicionado con vitaminas y minerales. Es un clásico de Marinela que puedes disfrutar en cualquier momento de antojo.',0,NULL,NULL,2,2,'#FB7F0E',53,14,NULL,'',1),
	(87,'*Mayonesa McCormic',0,NULL,NULL,'390 g','La mayonesa con jugo de limones McCormick es un aderezo que puedes incluir fácilmente en tus recetas favoritas y consentir a tu familia a la hora de la comida o cena. ',0,NULL,NULL,4,2,'#3ABE2C',54,1,NULL,'',1),
	(88,'Cheetos Bolita',0,NULL,NULL,'100 g','Botana Cheetos® Bolitas es una deliciosa opción hecha de cereal de maíz con el sabor a queso y chile que tanto te gusta. Para esos momentos familiares y divertidos, botana Cheetos® Bolitas es la perfecta elección. Para disfrutarlos aún más puedes compartirlos con todos tus amigos y familiares.',0,NULL,NULL,5,2,'#E7E71D',46,1,NULL,'',1),
	(89,'*Boing Mango',0,NULL,NULL,'250 ml','¡Ofrece a tus pequeños un delicioso Boing, solo para saciar su antojo! Hecho a base de pulpa de fresa con un tamaño práctico para llevarlo a cualquier lugar, aporta sólo 84 kcal. Ofrécelo frío de preferencia.',0,NULL,NULL,2,2,'#F58A48',28,14,NULL,'',1),
	...
	(91,'*Milanes',0,NULL,NULL,'1 pza','descripción de la milaneza',0,NULL,NULL,10,1,'#D68547',26,14,NULL,'',1),
	(92,'*Batido de frutos',0,NULL,NULL,'1 pza','Batido frutos del bosque',0,NULL,NULL,2,3,'#79D200',46,1,NULL,'',1),
	(93,'Jugo Ades Soya Manzana',0,NULL,NULL,'500 ml','Jugo Ades Soya Manzana',0,NULL,NULL,5,1,'#DBB100',23,12,NULL,'',1),
	(94,'Galletas Chokis',0,NULL,NULL,'200 g','Galletas chokis',0,NULL,NULL,2,3,'#6767FF',46,1,NULL,'',1),
	(95,'Pan integral',0,NULL,NULL,'340 g','Pan integral',0,NULL,NULL,200,2,'#FF8ABC',46,7,NULL,'',1),
	(96,'Refresco Coca-Cola',0,NULL,NULL,'500 ml','Cocacola 500 ml',0,NULL,NULL,100,3,'#E71F1F',2,12,NULL,'http://res.cloudinary.com/shingshing/image/upload/v1588726334/shingshing/productos/Refresco%20Coca-Cola.png',1);
...
VALUES
	...
	(88,'Roberto ',NULL,NULL,'1981-01-25',NULL,'+5215521891769','roberto.guadarrama@tradenial.com','roberto.guadarrama@tradenial.com','prueba123',NULL,NULL,NULL,NULL,'10640',NULL,NULL,1,'6236',1,NULL,1,'http://res.cloudinary.com/shingshing/image/upload/v1588730730/shingshing/usuarios/88.jpg','ff960cb55673958c594d0daaab1e368651c75c02f9687192a1811e7b180336a7',NULL,'2020-04-22 17:52:12',NULL,'2020-03-05 20:48:39',NULL),
